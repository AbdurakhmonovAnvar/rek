...
urlpatterns = [
    path('api/v1/get_token/', CustomTokenObtainView.as_view(), name='token'),  # token (login) post
    path('api/v1/refresh/', TokenRefreshView.as_view(), name='token_refresh'),  # access_tokenni yangilash
    path('api/v1/user/', UserGetView.as_view(), name='user-get'),  # userni yozgan postlarini olib beradi get
    path('api/v1/user/update/', UpdateUserView.as_view(), name='user-update'),  # userni  update qilish
    path('api/v1/user/delete/', DeleteUserView.as_view(), name='user-delete'),  # User ] delete qilish
    path('api/v1/user/create/', UserRegisterView.as_view(), name='user-create'), # Yangi user yaratish (registratsiya)
